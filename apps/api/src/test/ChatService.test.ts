...
describe('ChatService', () => {
  it('should stream a response when relevant notes are found', async () => {
    ...
    mockNoteRepository.findSimilar = vi.fn().mockResolvedValue([
    ...
    mockGraphRepository.findContextualRelationships = vi.fn().mockResolvedValue([]);
    ...
    const chatService = new ChatService(mockNoteRepository, mockVectorProvider, mockLlmProvider, mockGraphRepository);
